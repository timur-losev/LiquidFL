...
namespace gameswf
{
	...
	bool	button_record::read(lfl_stream* in, int tag_type, movie_definition_sub* m)
	...
	void	button_action::read(lfl_stream* in, int tag_type)
	{
	...
	void button_character_definition::sound_info::read(lfl_stream* in)
	{
	...
	void	button_character_definition::read(lfl_stream* in, int tag_type, movie_definition_sub* m)
