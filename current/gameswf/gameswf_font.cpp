...
namespace gameswf
{
	...
	void	font::read(lfl_stream* in, int tag_type, movie_definition_sub* m)
	{
	...
	void	font::read_font_info(lfl_stream* in, int tag_type)
	...
	void	font::read_font_alignzones(lfl_stream* in, int tag_type)
	...
	void	font::read_code_table(lfl_stream* in)
