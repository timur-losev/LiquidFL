...
namespace gameswf
{
	...
	typedef void (*as_c_function_ptr)(const function_call& fn);
	...
	public:
		...
		bool find_property(const lfl_string& name, as_value* val);
		bool find_property_owner(const lfl_string& name, as_value* val);
