...
namespace gameswf
{
	...
	lfl_stream::lfl_stream(tu_file* input)
		:
		m_input(input),
		m_current_byte(0),
		m_unused_bits(0)
	...
	lfl_stream::~lfl_stream()
	{
	}

	bool lfl_stream::read_bool() {
...
// 	}
	...
	int	lfl_stream::read_uint(int bitcount)
	...
	int	lfl_stream::read_sint(int bitcount)
...
//		IF_DEBUG(log_msg("stream::read_sint(%d) == %d\n", bitcount, value));
	...
	void	lfl_stream::align() { m_unused_bits = 0; m_current_byte = 0; }

	Uint8	lfl_stream::read_u8() { align(); return m_input->read_byte(); }
	Sint8	lfl_stream::read_s8() { align(); return m_input->read_byte(); }
	Uint16	lfl_stream::read_u16()
	{
		align();
...
//		IF_DEBUG(log_msg("val = 0x%X\n", val));
	...
	Sint16	lfl_stream::read_s16() { align(); return m_input->read_le16(); }
	Uint32	lfl_stream::read_u32()
	{
		align();
		Uint32	val = m_input->read_le32();
		return val;
	}
	Sint32	lfl_stream::read_s32() { align(); return m_input->read_le32(); }


	void lfl_stream::read_string(lfl_string* str)
	{
		align();
		str->resize(0);
	...
	void	lfl_stream::read_string_with_length(lfl_string* str)
	{
		align();
		str->resize(0);
	...
	void	lfl_stream::read_string_with_length(int len, lfl_string* str)
	{
//???		align();
		str->resize(0);
	...
	void	lfl_stream::set_position(int pos)
	...
	int	lfl_stream::get_tag_end_position()
