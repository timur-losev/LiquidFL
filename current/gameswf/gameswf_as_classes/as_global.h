...
namespace gameswf
{
	...
	void	as_global_assetpropflags(const function_call& fn);
	void  as_global_setinterval(const function_call& fn);
	void  as_global_clearinterval(const function_call& fn);
	void  as_global_settimeout(const function_call& fn);
	void  as_global_cleartimeout(const function_call& fn);
	void	as_global_update_after_event(const function_call& fn);
